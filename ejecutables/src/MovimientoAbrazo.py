...
joint_goal[8] = (0/180)*pi
joint_goal[9] = (0/180)*pi
joint_goal[10] = (0/180)*pi
joint_goal[11] = (0/180)*pi
joint_goal[12] = (0/180)*pi
joint_goal[13] = (0/180)*pi
...
while (i<3) and not rospy.is_shutdown():
	...
	joint_goal = group.get_current_joint_values()
	joint_goal[0] = (1/180)*pi
	joint_goal[1] = (45/180)*pi
	joint_goal[2] = (88/180)*pi
	joint_goal[3] = (23/180)*pi
	joint_goal[4] = (-84/180)*pi
	joint_goal[5] = (14/180)*pi
	joint_goal[6] = (-21/180)*pi
	joint_goal[7] = (180/180)*pi
	joint_goal[8] = (12/180)*pi
	joint_goal[9] = (87/180)*pi
	joint_goal[10] = (27/180)*pi
	joint_goal[11] = (-77/180)*pi
	joint_goal[12] = (5/180)*pi
	joint_goal[13] = (-21/180)*pi
	joint_goal[14] = (-180/180)*pi
